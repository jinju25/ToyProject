const qnaList = [
  {
    q: '1. 남녀사이에 친구가 가능할까?',
    a: [
      { answer: '무인도에 둘이 떨어져도 가능하다', score: 0 },
      { answer: '무슨일이 있을 지 모른다. 불가능하다', score: 1 },
    ]
  },
  {
    q: '2. 내 연인이 내 친구의 깻잎을 떼줬을 때 당신의 반응은?',
    a: [
      { answer: '별 신경 안쓴다', score: 0 },
      { answer: '조금 신경쓰이긴 하지만 굳이 말하진 않는다', score: 1 },
      { answer: '기분 나쁘다', score: 2 },
    ]
  },
  {
    q: '3.연인이 아닌 이성친구와의 스킨십 어디까지가 적당한가?',
    a: [
      { answer: '대화', score: 3 },
      { answer: '악수', score: 2 },
      { answer: '포옹', score: 1 },
  ...
  {
    q: '4. 내 친구가 롱패딩 지퍼를 못 올려서 끙끙대고 있다. <br> 만약 내 연인이 친구의 지퍼를 올려준다면?',
    a: [
      { answer: '아무 상관 없다', score: 0 },
      { answer: '좀 신경쓰이지만 넘어간다',score: 1 },
      { answer: '용서할 수 없다',score: 2 },
    ]
  },
  {
    q: '5. 연인이 친구들과 남자 여자 2:2로 1박2일 여행을 가도 되냐고 묻는다. 당신의 반응은?',
    a: [
      { answer: '그냥 보내준다', score: 0 },
      { answer: '좀 신경쓰이지만 어릴 때 부터 친구라고 하니 보내준다', score: 1 },
      { answer: '헤어질거면 가 ^^ ',score: 2 },
    ]
  },
  {
    q: '6. 연인이 오랜친구와 바디프로필을 준비한다고 한다. <br> 매일 같이 운동하고 카톡으로는 식단 공유까지.. 당신의 반응은?',
    a: [
      { answer: '살빠지고 좋네~! 운동 화이팅', score: 0 },
      { answer: '저게 돌았....', score: 1 },
    ]
  },
  {
    q: '7. 연인의 이성친구가 이별을 했다며 나의 연인에게 전화가 왔다.<br> 술 한잔 하며 위로해줘야겠다는 남친..(혹은 여친)',
    a: [
      { answer: '이해 해 준다.', score: 0 },
      { answer: '헤어질거면 가 ^^', score: 1 },
    ]
  },
